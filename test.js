...
//TEST
//console.log(orderTotals.reduce(reducer, 0));
...
const inventoryReducer = function(acc, inventoryItem){
  acc[inventoryItem.type] = acc[inventoryItem.type] + 1 || 1;
  return acc;
}
...
Metadata
Last modified: Aug 19, 2020, by MDN contributors
Related Topics
