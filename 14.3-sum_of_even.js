...
/**
  ...
  1. First find the line that contains the problem. Write it down -> 18
  2. Which debug method did you use to find the bug? breakpoint
  3. Explain the bug in your own words. -> return Nan because last index is out of array boundaries 
